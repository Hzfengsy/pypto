...
[MemoryReuse](33-memory_reuse.md#declared-allocations) for why an author would want it.
...
[MemoryReuse](33-memory_reuse.md#declared-allocations). Tiles on *different* slots are
